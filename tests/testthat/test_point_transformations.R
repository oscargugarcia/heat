# ===============================================================================
# UNIT TESTS FOR POINT TRANSFORMATION FUNCTIONS
# ===============================================================================
#
# Description:
#   This script tests the r2e2() pipeline with point geometries using
...
#
# Test Strategy:
#   - Runs r2e2() with each transformation type on point data
...
#
# Requirements:
#   - Baseline outputs must exist in tests/testthat/fixtures/baseline_output/point_transformations/
...
polygons_path <- testthat::test_path("fixtures", "data", "points.gpkg")

# Common parameters
poly_id_col <- "point_id"
...
if (should_print_banners()) {
  cat("\n")
  cat(strrep("=", 80), "\n")
  cat("TESTING CLIMATE DATA PIPELINE POINT TRANSFORMATIONS\n")
  cat(strrep("=", 80), "\n")
